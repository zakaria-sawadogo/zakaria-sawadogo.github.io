...
const dictionary: Record<string, string> = {
  ...
  "A federated threat-intelligence initiative connecting universities, CERTs, and public institutions across West Africa, enabling them to share attack signatures and indicators of compromise without exposing raw institutional data. The ambition is to become the region's first federated cyber-defense network.": "Une initiative fédérée de renseignement sur les cybermenaces reliant universités, CERT et institutions publiques d'Afrique de l'Ouest, leur permettant de partager signatures d'attaques et indicateurs de compromission sans exposer les données brutes de chaque institution. L'ambition est de devenir le premier réseau fédéré de cyberdéfense de la région.",
  ...
  "Seeking regional research partners": "Recherche de partenaires de recherche régionaux",
